...
namespace Final_Project_2022.EmployeeControl_Manager
{
    public partial class Employee_Manager_Form : Form
    {
        ...
        void FillGrid()
        {
            ...
            else if (inTable == "Labor")
            {
                dataGridViewEmployee.DataSource = employeeDB.GetLaborDataTable();
            }
        ...
        private void buttonSwitchLabors_Click(object sender, EventArgs e)
        {
            dataGridViewEmployee.DataSource = employeeDB.GetLaborDataTable();
            inTable = "Labor";
        }
        ...
        private void buttonUpdateInformation_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    EmployeeModel employee = employeeDB.GetEmployeeByID(Int32.Parse(dataGridViewEmployee.CurrentRow.Cells["id"].Value.ToString()));
